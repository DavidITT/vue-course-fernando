...
export default createStore({
  state: {
    todos: [
      ...
      { id: '2', text:'Recolectar piedrasdel alma', completed: true},
      { id: '3', text:'Recolectar piedra del poder', completed: true},
      { id: '4', text:'Recolectar piedras de la realidad', completed: false},
      { id: '5', text:'Conseguir nakamas', completed: false},
    ]
  },
  getters: {
